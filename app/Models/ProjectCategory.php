...
class ProjectCategory extends Eloquent {
    ...
    protected $collection = 'project_categories';
    ...
    public function list($request) {
        ...
        $list = ProjectCategory::where('deleted', '!=', 1);
        if ($keyword) {
    ...
    public static function getById($id){
        return ProjectCategory::find($id)->get(['title', 'seo_alias']);
    }
