...
class ProjectService extends Eloquent {
    ...
    protected $collection = 'project_services';
    ...
    public function list($request) {
        ...
        $list = ProjectService::where('deleted', '!=', 1);
        if ($keyword) {
    ...
    public static function getById($id){
        return ProjectService::find($id)->get(['title', 'seo_alias']);
    }
