...
class PostMetaItem extends Eloquent {

    use SlugTrait;
    protected $connection = 'mongodb';
    protected $collection = 'post_meta_items';
    ...
    public function list($request) {
        ...
        $list = PostMetaItem::where('deleted', '!=', 1);
        if ($keyword) {
    ...
    public static function getById($id){
        return PostMetaItem::find($id)->get(['title', 'seo_alias']);
    }
