        ...
        <div style="width: 100%; margin-left: auto; margin-right: auto;">
            ...
            <div style="margin-top: 25px;">
                ...
                <div style="text-align: left; margin-bottom: 10px;margin-top: 10px;font-size: 16px;color: #000; ">
                    Jillian has completed refund procedure for order #{{ isset($order->title) ? $order->title : '' }}, total refund is {{ isset($order->total_price) ? \App\Helpers\Common::money_format($order->total_price) : 0 }}.
                </div>
                <div style="text-align: left; margin-bottom: 10px;margin-top: 10px;font-size: 16px;color: #000; ">
                    The transfer time will depend on the type of refund you have selected. Please refer to the policy on the website for more details.
                </div>
                    ...
                    <div style="position: relative; margin-bottom: 20px;">
                        <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;">
                            <img src="{{$url_icon}}" width="12"/> Status: <span
                                    style="font-weight: 700">Refund successful</span></div>
                    </div>
                    <div style="position: relative; margin-bottom: 20px;">
                        <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;">
        ...
        <div style="padding-bottom: 0px;">
            <div style="width: 100%; margin-left: auto; margin-right: auto;">
                ...
                <div style="margin-top: 25px;">
                    ...
                    <div style="text-align: left; margin-bottom: 10px;margin-top: 10px;font-size: 16px;color: #000; ">
                        Jillian đã hoàn tất thủ tục hoàn tiền cho đơn hàng #{{ isset($order->title) ? $order->title : '' }}, tổng giá trị hoàn trả là {{ isset($order->total_price) ? \App\Helpers\Common::money_format($order->total_price) : 0 }}.
                    </div>
                    <div style="text-align: left; margin-bottom: 10px;margin-top: 10px;font-size: 16px;color: #000; ">
                        Thời gian chuyển tiền sẽ phụ thuộc vào hình thức hoàn tiền quý khách đã lựa chọn. Vui lòng tham khảo chính sách tại website để biết thêm chi tiết.
                    </div>
                    <div style="text-align: left; text-transform: uppercase; margin-bottom: 25px;font-size: 16px;font-weight: 500;color: #000; ">
                        ...
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;">
                                <img src="{{$url_icon}}" width="12"/> Tình trạng: <span
                                        style="font-weight: 700">Hoàn tiền thành công</span></div>
                        </div>
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;">
