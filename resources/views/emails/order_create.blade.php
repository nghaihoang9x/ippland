    ...
    <div style="width: 100%; margin-left: auto; margin-right: auto;">
        ...
        <div style="margin-top: 25px;">
            ...
            <div style="text-align: left; margin-bottom: 10px;margin-top: 10px;font-size: 16px;color: #000; ">
                Thank you for your purchase on Jillianperfume.com.
            </div>
            ...
            <div style="padding: 0;">
                <div style="position: relative; margin-bottom: 20px;">
                    <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Status: <span style="font-weight: 700">Order successful</span></div>
                </div>
                <div style="position: relative; margin-bottom: 20px;">
                    <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Order number: <span style="font-weight: 700">{{ isset($order->title) ? $order->title : '000000' }}</span></div>
                </div>
                <div style="position: relative; margin-bottom: 20px;">
                    <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Order details:</div>
        ...
        <div style="padding-bottom: 0px;">
            <div style="width: 100%; margin-left: auto; margin-right: auto;">
                ...
                <div style="margin-top: 25px;">
                    ...
                    <div style="padding: 0;">
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Tình trạng: <span style="font-weight: 700">Đặt hàng thành công</span></div>
                        </div>
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Mã đơn hàng: <span style="font-weight: 700">{{ isset($order->title) ? $order->title : '000000' }}</span></div>
                        </div>
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Thông tin sản phẩm:</div>
                            <div style="margin-top: 10px; padding-left: 17px;">
                                <table style="width: 100%; border-radius: 10px; overflow: hidden; background-color: #f5f5f5; font-weight: bold;font-size: 16px;" cellpadding="15" cellspacing="0">
                                    <tr>
                                        <td style="font-size: 16px;width: 45%;">
                        ...
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Tổng thanh toán: <span style="font-weight: 700">{{ isset($order->total_price) ? \App\Helpers\Common::money_format($order->total_price) : 0 }}</span></div>
                        </div>
                        <div style="position: relative; margin-bottom: 20px;">
                            <div style="font-size: 16px; letter-spacing: 0.32px; text-align: left; color: #151515; position: relative;"><img src="{{$url_icon}}" width="12" /> Hình thức thanh toán: <span style="font-weight: 700">{{ isset($order->payment_method) ? $order->payment_method : 'COD'}}</span></div>
                        </div>
                    </div>
                </div>
            </div>
